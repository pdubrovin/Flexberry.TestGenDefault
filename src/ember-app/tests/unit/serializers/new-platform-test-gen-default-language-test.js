...
moduleForModel('new-platform-test-gen-default-language', 'Unit | Serializer | new-platform-test-gen-default-language', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-test-gen-default-language',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
